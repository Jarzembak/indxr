...
- Default 6th book color changed from teal to pink (`#E84393`).

## [0.3.0] - 2026-05-25

### Added

- `--color / --no-color` option on the `books`, `master`, `compact`, and `all`
  commands to enable or disable per-book color coding. Color is enabled by
  default; `--no-color` produces neutral, monochrome PDFs (no swatches, color
  bars, or color key).
...
[0.3.1]: https://github.com/Jarzembak/indxr/compare/v0.3.0...v0.3.1
[0.3.0]: https://github.com/Jarzembak/indxr/compare/v0.2.0...v0.3.0
